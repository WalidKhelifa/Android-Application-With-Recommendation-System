...
public class FragmentSelectionRepasAdapter extends RecyclerView.Adapter<FragmentSelectionRepasAdapter.ViewHolder> implements Filterable {

    private ArrayList<Plat> plats;
    private ArrayList<Plat> platsResearch;
    private Context context;
    private FragmentSelectionRepasAdapter.OnItemCLickListener listener;


    public FragmentSelectionRepasAdapter(Context cxt, ArrayList<Plat> list) {
    ...
    @NonNull
    @Override
    public FragmentSelectionRepasAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.selection_repas_card_layout, viewGroup, false);

        FragmentSelectionRepasAdapter.ViewHolder viewHolder = new FragmentSelectionRepasAdapter.ViewHolder(v, this.listener, plats);
        return viewHolder;
    }
    ...
    public void setOnItemClickListener(FragmentSelectionRepasAdapter.OnItemCLickListener listener) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, final FragmentSelectionRepasAdapter.OnItemCLickListener listener, final ArrayList<Plat> p) {
            super(itemView);
            image = itemView.findViewById(R.id.img_plat_repas);
            name =  itemView.findViewById(R.id.name_repas);
            price= itemView.findViewById(R.id.price_repas);
            add=itemView.findViewById(R.id.add_repas);
