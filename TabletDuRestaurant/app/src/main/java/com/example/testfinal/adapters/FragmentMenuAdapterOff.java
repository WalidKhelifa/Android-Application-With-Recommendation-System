...
public class FragmentMenuAdapterOff extends RecyclerView.Adapter<FragmentMenuAdapterOff.ViewHolder> implements Filterable {
    ...
    public FragmentMenuAdapterOff(Context cxt, ArrayList<Plat> list)
     {
         context=cxt;
    ...
    @NonNull
    @Override
    public FragmentMenuAdapterOff.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.menu_card_layout_off, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final FragmentMenuAdapterOff.ViewHolder viewHolder, int i) {
